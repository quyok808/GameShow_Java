...
public class frmVong2 extends javax.swing.JFrame {
    ...
    public frmVong2(Socket socket, String playerName) {
        initComponents();
        this.socket = socket;
        this.playerName = playerName;
        connectToServer();
    ...
    private void connectToServer() {
        try {
            ...
            sendToServer("START_SECONDROUND");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmVong2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
